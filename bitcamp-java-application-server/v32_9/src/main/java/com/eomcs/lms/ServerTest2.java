...
public class ServerTest2 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (Socket socket = new Socket("192.168.43.153", 8888);
      ...
      lesson.setEndDate(Date.valueOf("2019-01-01"));
      ...
      lesson.setStartDate(Date.valueOf("2019-02-02"));
      lesson.setEndDate(Date.valueOf("2019-03-03"));
  ...
  private static boolean quit() throws IOException {
