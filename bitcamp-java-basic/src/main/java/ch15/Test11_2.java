...
public class Test11_2 {
  public static void main(String[] args) {
    ...
    System.out.println(classInfo.getName()); //[Ljava.lang.String; // 스트링 배열
    
    int[] obj3 = new int[10];
    classInfo = obj3.getClass();
    System.out.println(classInfo.getName()); //[I // 인트배열

    float[] obj4 = new float[10];
    classInfo = obj4.getClass();
    System.out.println(classInfo.getName()); //[F // Float배열
