...
public class Test01_3 {
  public static void main(String[] args) throws Exception {
    ...
    while ((b = in.read()) != -1) {
      count++;
      // 겉으로는 1바이트씩 읽는 것 같다.
      // 그래서 1바이트를 암호화시키기 위해 코드도 여기에 바로 작성하면 된다.
      // Test01_2.java에 비교하면 훨시니 편하다.
      // 편하면서 동시에 읽기 속도도 높였다.
      // 어떻게?
      // => BufferedInputStream의 read()메소드는 FileInputStream에서 상속 받은
      // 메소드를 이용하면 먼저 바이트 배열 단위로 데이터를 가져온 다음에
      // 그 배열에서 1바이트를 리턴한다.
