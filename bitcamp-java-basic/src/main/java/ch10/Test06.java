...
class Monitor4 {
  ...
  {
    System.out.println("인스턴스 초기화 블록실행!");
    bright = 20;
    contrast = 20;
    widthRes = 800;
    heightRes = 600;
  ...
  // => 다음과 같이 파라미터의 값을 주지 않으면 기본 파라미터 값을 안받는 생성자가 호출된다. 
  //    예)  Monitor4()
  // => 파라미터를 받지 않는 생성자를 기본 생성자(default constructor)라 부른다.
...
public class Test06 {
  public static void main(String[] args) {
    // 모니터 인스턴스 생성
    // 1) Monitor4 설계도에 따라 인스턴스 필드를 Haep에 생성한다.
    // 2) 필드의 초기화 문장을 실행한다. 
    // 예) int bright = 10;
    // 3) 인스턴스 초기화 블록을 실항한다. 
    // 예)  {
...
//           bright = 20;
//          }
    // 4) 파라미터를 안받는 생성자(default constructor)를 호출한다.
    // 예) Monitor4() {...}
    // 
