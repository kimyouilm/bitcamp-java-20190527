...
// => DAO 인터페이스를 구현한 객체를 자동으로 생성하여 IoC컨테이너에 보관한다.
// => DAO 객체의 메소드를 호출할 때 인터페이스의 이름과 메소드명을 합쳐서
//    SQL문을 Mapper 파일에서 찾는다.
...
public class MybatisConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // 이런 설정 파일 없이 스프링 IoC 컨테이너에서 SqlSessionFactory를 만들수 있도록
