...
// Mybatis가 관리하던 DataSource를  Spring에서 관리해줌 (둘이 연동하면)
...
// 이거 꼭 적어주자 "" 경로의 properties파일을 읽어라.
...
public class DatabaseConfig {
  ...
  //    
  @Bean//                           type이 DataSource임   dataSource()의 return 값이 들어감
  // transactionManager txManage말고 풀로 적으삼 
