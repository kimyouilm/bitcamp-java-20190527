...
public class AppConfig4 {
  ...
  // 예) 다른사람이 만든 인스턴스를 우리 IoC 컨테이너에 등록하고 싶을때 사용한다.
  //     => SqlSessionFactory, DataSource, PlatformTransactionManager등...
  @Bean("blackBox")
  ...
  @Bean
  // 파라미터로 iocContainer를 달라고하면 통째로 줘버려~~
  // ApplicationContext iocContainer =
  // new AnnotationConfigApplicationContext(AppConfig4.class); 이거와 같은놈임~~
