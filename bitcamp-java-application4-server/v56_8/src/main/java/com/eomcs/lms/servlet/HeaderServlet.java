...
public class HeaderServlet extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    out.println("<a class='navbar-brand' href='/board/list'>" 
    ...
    out.println("</li>");
    out.println("<li class='nav-item active'>");
    out.println("<a class='nav-link' href='/lesson/lis'>수업관리</a>");
    out.println("</li>");
    out.println("<li class='nav-item active'>");
    ...
    if (loginUser == null) {
      out.println("  <a type='button' class='btn btn-outline-dark btn-sm' href='/auth/login'>로그인</a>");
    } else {
      out.printf("<a href='/member/detail?no=%d'>%s</a>", loginUser.getNo(), loginUser.getName());
      out.println("<a type='button' class='btn btn-outline-dark btn-sm'href='/auth/logout'>로그아웃</a>");
    }
    out.println("</div>");
