...
// => Spring IoC컨테이너를 준비한다.
// => ServletContext보관소에 IoC컨테이너를 저장한다.
//
public class ContextLoaderListener implements ServletContextListener{
  ...
  public void contextInitialized(ServletContextEvent sce) {
    // web application이 시작될때 서블릿 컨테이너가 호출하는 메소드
    ...
    if (contextClass != null) {
      try {
        ...
        // 해당 클래스의 생성자 중에서 자바 패키지의 이름을 문자열로 받는 생성자를 꺼낸다.
    ...
    // Spring IoC 컨테이너를 서블릿에서 사용할 수 있도록 ServletContext보관소에 저장한다.
