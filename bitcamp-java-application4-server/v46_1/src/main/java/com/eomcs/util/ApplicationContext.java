...
public class ApplicationContext {
  ...
  public ApplicationContext() throws Exception {
    ...
    objPool.put("/lesson/delete", new LessonDeleteCommand(sqlSessionFactory));
    objPool.put("/lesson/detail", new LessonDetailCommand(sqlSessionFactory));
    objPool.put("/lesson/list", new LessonListCommand(sqlSessionFactory));
    objPool.put("/lesson/update", new LessonUpdateCommand(sqlSessionFactory));

    objPool.put("/member/add", new MemberAddCommand(sqlSessionFactory));
    objPool.put("/member/delete", new MemberDeleteCommand(sqlSessionFactory));
    objPool.put("/member/detail", new MemberDetailCommand(sqlSessionFactory));
    objPool.put("/member/list", new MemberListCommand(sqlSessionFactory));
    objPool.put("/member/update", new MemberUpdateCommand(sqlSessionFactory));
    objPool.put("/member/search", new MemberSearchCommand(sqlSessionFactory));
